...
class LoveDATrainDataset(Dataset):
    def __init__(self, data_root='./datasets/LoveDA/Train/', img_dir='images_png', mosaic_ratio=0.25,
...
loveda_val_dataset = LoveDATrainDataset(data_root='./datesets/LoveDA/Val/', mosaic_ratio=0.0,
                                        transform=val_aug)


class LoveDATestDataset(Dataset):
    def __init__(self, data_root='./datesets/LoveDA/Test/', img_dir='images_png',
