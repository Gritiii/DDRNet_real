...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, required=True, help="config/loveda/unetformer.py")
    ...
    if args.tta == "lr":
        ...
        transforms = tta.Compose(
            [
                ...
                tta.Scale(scales=[0.5,0.75, 1.0, 1.25, 1.5,1.75], interpolation='bicubic', align_corners=False),
